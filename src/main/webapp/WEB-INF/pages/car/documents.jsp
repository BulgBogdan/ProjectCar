                ...
                <div class="container">
                    <div class="row col-md-12 col-md-offset-0">
                        <table class="table table-striped">
                            ...
                            <c:if test="${yellowDate != null}">
                                <c:forEach items="${yellowDate}" var="docs">
                            ...
                            <c:if test="${redDate != null}">
                                <c:forEach items="${redDate}" var="docs">
                            ...
                            <c:if test="${endDate != null}">
                                <c:forEach items="${endDate}" var="docs">
                                    <tr>
                                        <td class="text-center">${docs.nameDocument}</td>
                                        <c:if test="${car.user.currency.id == 1}">
                                            <td class="text-center">
                    ...
                    <div class="dropdown text-right">
                        ...
                        <ul class="dropdown-menu text-center">
                            <b class="text-danger">
                                <fmt:formatNumber value="${allDocumentsCosts}" maxFractionDigits="2"/>
