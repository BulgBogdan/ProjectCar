...
<div class="container-fluid h-100">
    <div class="row h-100">
        ...
        <main class="col offset-md-0 bg-faded py-0">
                        ...
                        <c:forEach items="${otherCosts}" var="costs">
                            <tr>
                                ...
                                <td class="text-center"><a class='btn btn-info btn-xs' href="${editCost}">
                                    ...
                                    <c:url value="/car/other/costs/delete/${costs.id}" var="deleteCost"/>
                                    <a href="${deleteCost}" class="btn btn-danger btn-xs">
            ...
            <c:if test="${(parameters != null) && (otherCosts.size() == 0)}">
            <br>
            <p>В вашем каталоге нет затарат, <a href="${createCost}"> добавить?</a></p>
            </c:if>
            <c:if test="${parameters == null}">
            ...
            <div class="text-center">
                <b class="text-info">Сумма затрат равна <b class="text-danger">${sumAllCosts}</b></b>
            </div>
