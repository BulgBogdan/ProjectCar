...
<div class="container-fluid h-100">
    <div class="row h-100">
        ...
        <main class="col offset-md-0 bg-faded py-0">
            ...
            <c:if test="${repairs.size() != 0}">
                <div class="container">
                    <div class="row col-md-12 col-md-offset-2">
                            ...
                            <c:if test="${greenMileage != null}">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a class='btn btn-info btn-xs' href="${editRepair}">
                                        ...
                                        <c:url value="/car/repairs/delete/${repair.id}" var="deleteRepair"/>
                                        <a href="${deleteRepair}" class="btn btn-danger btn-xs">
                        ...
                        <a href="${createRepair}" class="btn btn-primary btn-xs pull-right"><b>+</b> Добавить ремонт</a>
                        <span class="text-info text-right"
                              style="margin-left: 70px; font-size: 120%">Количество ремонтов: ${repairCount}</span>
                        <div class="container text-center">
                            <c:if test="${pagesCount > 1}">
                                <c:set value="disabled" var="disabled"/>
                                <c:set value="" var="active"/>
                                <c:url value="/car/repairs/${car.id}" var="url">
                    ...
                    <div class="dropdown text-right">
                        <a href="#" data-toggle="dropdown" class="dropdown-toggle"
                           title="Нажмите, чтобы развернуть и посмотреть">
                            Сумма затрат на ремонт и запчасти
                            <b class="caret"></b>
                        </a>
            ...
            <c:if test="${(parameters != null) && (repairs.size() == 0)}">
                <br>
                <p>В вашем каталоге нет произведенных ремонтов, <a href="${createRepair}"> добавить?</a></p>
            </c:if>
            <c:if test="${parameters == null}">
