                    ...
                    <div class="collapse navbar-collapse align-items-start">
                        <ul class="flex-md-column flex-row navbar-nav w-100 justify-content-between">
                            ...
                            <small><p>Приложение MyCar, позволяет вести учет всех затрат на ваш автомобиль. Если
                                редактировать пробег и указывать все данные, вы увидите, сколько денег требует ваш
                                автомобиль.</p></small>
                            <small><p>Также приложение показывает, какой срок износа у замененной детали, что
                                позволяет контролировать заявленные сроки детали.</p></small>
                            <small><p>В дальнейшем можно будет смотреть динамику роста топлива, а при помощи
                                автоматического подсчета расхода вашего автомобиля, будет показано среднее расстояние,
                                которое может преодолеть автомобиль, после заправки.</p></small>
                            <small><p>Все это делается для подсчета вашего бюджета и контроля затрат. Все это позволяет
                                предположить вам, сколько необходимо на обслуживание авто в дальнейшем.</p>
                            </small>
                        </ul>
                    </div>
                </nav>
