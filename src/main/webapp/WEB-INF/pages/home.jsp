                ...
                <nav class="navbar navbar-expand navbar-light bg-light flex-md-column flex-row align-items-start py-0">
                    <div class="collapse navbar-collapse align-items-start" style="height: 100vh">
                        <ul class="flex-md-column flex-row navbar-nav w-100 justify-content-between">
                            ...
                            <small><p>Возможности:</p></small>
                            <small><p>&#9830 Учет всех затрат на автомобиль - если редактировать пробег и указывать все
                                запрашиваемые данные, вы увидите, сколько денег требует ваш автомобиль;</p></small>
                            <small><p>&#9830 Контроль срока износа замененной детали, что позволяет контролировать
                                заявленные
                                сроки её службы;</p></small>
                            <small><p>&#9830 Рассчитать среднее расстояние, которое может преодолеть автомобиль после
                                заправки;</p></small>
                            <small><p>&#9830 Видеть динамику роста цены на топливо.</p></small>
